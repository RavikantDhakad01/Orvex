...
function CreateProjectModel({ setModelOpen }) {
  ...
  return (
    <>
      <div className="flex relative flex-col">
        <h1 className="text-center font-bold text-lg">Create Project</h1>
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center gap-4">
            <Button
              text="Cancel"
              className="text-black border border-gray-600 bg-white py-0 cursor-pointer"
              type="button"
